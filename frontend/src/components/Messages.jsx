...
export default function Messages() {
  ...
  useEffect(() => {
    socket = io('https://social-hub-sqid.onrender.com')
  ...
  const fetchConversations = async () => {
    const res = await fetch(`https://social-hub-sqid.onrender.com/messages/conversations/${user?.userId}`)
    const data = await res.json()
    if (res.ok) setConversations(data.conversations)
  }

  const fetchFriends = async () => {
    const res = await fetch(`https://social-hub-sqid.onrender.com/users/friends/${user?.userId}`)
    const data = await res.json()
    if (res.ok) setFriends(data.friends || [])
  }

  const fetchMessages = async (id) => {
    const res = await fetch(`https://social-hub-sqid.onrender.com/messages/chat/${user?.userId}/${id}`)
    const data = await res.json()
  ...
  const handleSendMessage = async () => {
    ...
    await fetch('https://social-hub-sqid.onrender.com/messages/send', {
      method: 'POST',
